...
var resizePizzas = function(size) {
  ...
  //Optimization: More specific selector, function more efficiently changes pizza sizes
  function changePizzaSizes(size) {
    //Optimization: Took the query out of for-loop initialization and for-loop
    //Optimization: Took the calculation for new width out of the for-loop
...
function updatePositions() {
  ...
  //Optimization: took scrolling out of loop so it doesn't force a query every time the loop runs
